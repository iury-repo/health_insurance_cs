...
**Disclaimer:** This project was inspired by the Kaggle challenge dataset [Health Insurance Cross Sell Prediction](https://www.kaggle.com/datasets/anmolkumar/health-insurance-cross-sell-prediction?select=train.csv).
All procedures applied and steps made are the standart for real world projects and can be adapted for more complex datasets. 
